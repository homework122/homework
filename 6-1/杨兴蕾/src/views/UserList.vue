<template>
  <div class="userList">
    <!--导航-->
    <el-row>
      <el-col :span="20"><div class="grid-content bg-purple-dark"><h1>会员列表</h1></div></el-col>
      <el-col :span="4"><div class="grid-content bg-purple-dark" style="margin-top: 20px"><img src="../assets/img/logo.png" style="width: 30px;height: 30px;border-radius: 30px;"></div></el-col>
    </el-row>
    <!--查询-->
    <el-row>
      <el-col :span="24">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-popover
            ...
            <el-button slot="reference"  @click=" handleEdit (scope.$index, scope.row) " size="medium"  style="margin: 10px" >编辑</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
