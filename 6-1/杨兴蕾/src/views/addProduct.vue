<template>
  <div class="addProduct">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/indexLink' }">商品</el-breadcrumb-item>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      <el-form-item label="商品分类" prop="catId" hide-required-asterisk="true">
        ...
        <!--<el-select v-model="ruleForm.catId" placeholder="请选择" size="medium">-->
      ...
      <el-form-item label="商品推荐" prop="goodsRecom">
        ...
        <!--<el-switch v-model="ruleForm.goodsRecom"></el-switch>-->
      </el-form-item>
      <!--<el-form-item label="服务保证" prop="serve">-->
        <!--<el-checkbox-group v-model="ruleForm.serve">-->
          <!--<el-checkbox label="无忧退货" name="serve"></el-checkbox>-->
          <!--<el-checkbox label="快速退款" name="serve"></el-checkbox>-->
          <!--<el-checkbox label="免费包邮" name="serve"></el-checkbox>-->
        <!--</el-checkbox-group>-->
      <!--</el-form-item>-->
      <h3>填写商品属性</h3>
      ...
      <el-form-item label="商品相册" prop="goodsImgs">
        ...
        <!--<el-upload-->
          ...
          <!--<img v-if="imageUrl" :src="ruleForm.goodsImgs" class="avatar">-->
