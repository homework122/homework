<template>
    <div class="productList">
      ...
      <el-row>
        ...
        <el-col :span="4"><div class="grid-content bg-purple-dark"><img src="../assets/img/logo.png" alt=""></div></el-col>
      </el-row>
      <!--搜索-->
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-popover
              ...
              <el-button slot="reference"  @click=" handleEdit (scope.$index, scope.row) " size="small">编辑</el-button>
            </el-popover>
          </template>
        </el-table-column>
      </el-table>
